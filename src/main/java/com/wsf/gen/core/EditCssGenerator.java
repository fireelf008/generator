...
public class EditCssGenerator {

    private Config config;

    public EditCssGenerator(Config config) {
        this.config = config;
    }
    ...
    public void create() {
        try {
            ...
            Template template = configuration.getTemplate("edit_css.ftl");
            File file = new File(config.getEditCssFilePath());
