...
public class AddCssGenerator {

    private Config config;

    public AddCssGenerator(Config config) {
        this.config = config;
    }
    ...
    public void create() {
        try {
            ...
            Template template = configuration.getTemplate("add_css.ftl");
            File file = new File(config.getAddCssFilePath());
