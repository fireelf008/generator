...
public class ListJsGenerator {

    private Config config;

    public ListJsGenerator(Config config) {
        this.config = config;
    }
    ...
    public void create() {
        try {
            ...
            Template template = configuration.getTemplate("list_js.ftl");
            File file = new File(config.getListJsFilePath());
