...
<head>
    ...
    <link rel="stylesheet" href="/css/mng/${config.modularName}/${config.varEntityName}_add.css" media="all">
</head>
<body>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" id="${config.fieldColumnMap[key].name}" name="${config.fieldColumnMap[key].name}" autocomplete="off">
            </div>
        </div>
        </#list>
    </div>
...
<script src="/js/mng/${config.modularName}/${config.varEntityName}_add.js"></script>